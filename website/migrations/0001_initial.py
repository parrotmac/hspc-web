# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-10-22 22:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repeated_item_text', models.CharField(blank=True, help_text="e.g. 'Section home' or 'Overview'. If left blank, the page title will be used.", max_length=255, verbose_name='repeated item link text')),
                ('body', wagtail.wagtailcore.fields.RichTextField(blank=True)),
                ('membership_text', wagtail.wagtailcore.fields.RichTextField(blank=True)),
                ('collaboration_text', wagtail.wagtailcore.fields.RichTextField(blank=True)),
                ('marketplace_text', wagtail.wagtailcore.fields.RichTextField(blank=True)),
            ],
            options={
                'abstract': False,
            },
